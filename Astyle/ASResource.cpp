...
const string ASResource::OX_AND_ASSIGN   = string("~="); ////add  Oxcleaner

const string ASResource::OX_DOT_NOTEQUAL   = string(".!=");  ////add  Oxcleaner
const string ASResource::OX_DOT_LE = string(".<=");  ////add  Oxcleaner
const string ASResource::OX_DOT_GR  = string(".>=");  ////add  Oxcleaner
const string ASResource::OX_DOT_EQUAL = string(".==");////add  Oxcleaner
...
void ASResource::buildAssignmentOperators(vector<const string*>* assignmentOperators)
{
	...
	assignmentOperators->push_back(&OX_AND_ASSIGN); //add  Oxcleaner
...
{
	//Ox malick
	nonAssignmentOperators->push_back(&OX_DOT_NOTEQUAL);
	nonAssignmentOperators->push_back(&OX_DOT_LE);
	nonAssignmentOperators->push_back(&OX_DOT_GR);
	nonAssignmentOperators->push_back(&OX_DOT_EQUAL);
...
void ASResource::buildOperators(vector<const string*>* operators, int fileType)
{
	...
	operators->push_back(&OX_AND_ASSIGN);
	operators->push_back(&OX_DOT_NOTEQUAL);
	operators->push_back(&OX_DOT_LE);
	operators->push_back(&OX_DOT_GR);
	operators->push_back(&OX_DOT_EQUAL);
