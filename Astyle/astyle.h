...
class ASResource
{
	...
	static const string OX_AND_ASSIGN , OX_DOT_AND   ; ////add  Oxcleaner
	static const string OX_BIT_XOR ; ////add  Oxcleaner
	static const string OX_DOT_NOTEQUAL  ;  ////add  Oxcleaner
	static const string OX_DOT_LE  ;  ////add  Oxcleaner
	static const string OX_DOT_GR  ;  ////add  Oxcleaner
	static const string OX_DOT_EQUAL;////add  Oxcleaner
		...
		static const string AS_QUESTION_QUESTION, AS_LAMBDA; ///add  Oxcleaner
