...
/*!re2c
    ...
    Pound PPSpaceE:\boost_1_65_1\stage\lib PPSpace "<" (any\[\n\r>])+ ">" 
        { BOOST_WAVE_RET(T_PP_HHEADER); }

    Pound PPSpace ( "import" |"include" | "include_next") PPSpace "\"" (any\[\n\r"])+ "\"" 
        { BOOST_WAVE_RET(T_PP_QHEADER); } 

    Pound PPSpace ( "import" | "include" | "include_next") PPSpace
